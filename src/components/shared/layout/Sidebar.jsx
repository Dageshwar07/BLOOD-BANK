                ...
                <div className="flex flex-no-wrap">
                    ...
                    <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
                        ...
                        <ul aria-orientation="vertical" className=" py-6">
                            ...
                            <li className="pl-6 cursor-pointer  text-sm leading-3 tracking-normal pb-4 pt-5  hover:text-blue-500 focus:text-blue-700 ">
                            ...
                            {user?.role === "organisation" && (<>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/'>  <span className="ml-2">Inventory</span></Link>
                                    </div>
                                </li>

                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/donar'> <span className="ml-2">Donar</span></Link>
                                    </div>
                                </li>


                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/hospital'><span className="ml-2">Hospital</span></Link>
                                    </div>
                                </li>
                            ...
                            {user?.role === "admin" && (<>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user-heart" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                                        ...
                                        <Link to='/donar-list'> <span className="ml-2">Donar list</span></Link>
                                    </div>
                                </li>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/hospital-list'><span className="ml-2">Hospital list</span></Link>
                                    </div>
                                </li>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 py-2  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/organisation-list'> <span className="ml-2">Organisation-list</span></Link>
                                    </div>
                                </li>
                            ...
                            {(user?.role === "donar" || user?.role === "hospital") && (<>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 pt-5  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path>
                                        ...
                                        <Link to='/organisation'> <span className="ml-2">Organisation</span></Link>
                                    </div>
                                </li>
                            ...
                            {(user?.role === "hospital") && (<>
                                ...
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 pt-5  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/consumer'> <span className="ml-2">Consumer</span></Link>
                                    </div>
                                </li>
                            ...
                            {user?.role === "donar" && (<>
                                <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 pt-5  hover:text-blue-500 focus:text-blue-700 ">
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/donation'> <span className="ml-2">Donation</span></Link>
                                    </div>
                                </li>
