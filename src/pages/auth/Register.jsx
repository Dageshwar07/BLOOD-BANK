        ...
        <>
            ...
            {loading ? (<></>) : (
                <section className="bg-gray-50 dark:bg-gray-900">
                    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:h-max">
                        ...
                        <Form1 formTitle={'Create your account'} submitBtn={'Register'} formType={'register'} />
